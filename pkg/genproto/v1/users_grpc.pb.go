...
type UsersServiceClient interface {
	...
	SyncUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *usersServiceClient) SyncUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/users.UsersService/SyncUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServiceServer interface {
	...
	SyncUsers(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
}
...
func (UnimplementedUsersServiceServer) SyncUsers(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _UsersService_SyncUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.UsersService/SyncUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).SyncUsers(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
