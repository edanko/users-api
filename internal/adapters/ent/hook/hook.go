...
type UserFunc func(context.Context, *ent2.UserMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f UserFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	mv, ok := m.(*ent2.UserMutation)
	if !ok {
